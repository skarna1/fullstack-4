...
describe('total likes', () => {
  ...
  test('when list has only one blog with 0 likes equals the likes of 0', () => {
    const result = listHelper.totalLikes(listWithOneBlogWithZeroLikes)
  ...
  test('when list has zero elements equal to 0', () => {
